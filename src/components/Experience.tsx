  ...
  const experiences = [
    {
      ...
      subtitle: 'Full Stack - AI & Video Platforms',
      ...
      highlights: [
        ...
        'Optimized the performance of an existing admin panel and migrated it to React for improved user experience.',
        'Developed responsive screens using a modular approach to ensure flexibility and maintainability.',
